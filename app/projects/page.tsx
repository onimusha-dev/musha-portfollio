...
function EmptyState() {
    return (
        <div className="flex flex-col items-center justify-center py-32 text-center">
            {/* animated terminal blinking cursor icon */}
            <div
...
/* ─────────────────────────────────────────────────────────────
   SKELETON CARD — shown while loading (for future dynamic use)
───────────────────────────────────────────────────────────── */
function SkeletonCard() {
    return (
        ...
        >
            {/* image area */}
            <div className="h-44 w-full" style={{ background: "var(--c0)" }} />
            <div className="p-5">
        ...
        >
            ...
            <div className="flex flex-col flex-1 p-5">
                <div className="flex items-start justify-between gap-3 mb-2.5">
                    ...
                    <Icons.External
                        className="w-4 h-4 shrink-0 mt-0.5 opacity-30 group-hover:opacity-100 group-hover:text-accent transition-all duration-200"
                    />
                </div>
